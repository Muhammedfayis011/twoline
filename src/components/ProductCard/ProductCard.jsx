...
import { ShoppingCart, ChevronRight, ChevronLeft } from '../../icons';
...
export default function ProductCard({ product }) {
  ...
  return (
    <article className="product-card" id={`product-card-${product.id}`}>
      <div className="product-card-img" onClick={() => navigate(`/product/${product.id}`)} style={{ cursor: 'pointer', position: 'relative', overflow: 'hidden' }}>
